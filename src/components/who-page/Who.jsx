...
import { Facebook, LinkedIn, Gmail, FooterBanner } from '../../assets/index';
...
const FirstPage = ({ children }) => (
	<GenericFirstPageFullViewHeightContainer id='who'>
		<HugeHeading>Who.</HugeHeading>
		<Blue3DImage />
	</GenericFirstPageFullViewHeightContainer>
);
...
const GenericFirstPageFullViewHeightContainer = ({ children, page }) => (
	<main
		id={`${page}-landing`}
		className='flex flex-grow justify-center flex-col h-screen items-center'>
		<SingleColumn id='single-column-who' addClasses='m-auto'>
			{children}
		</SingleColumn>
	</main>
);
