	...
	<SingleColumn addClasses='flex flex-col flex-grow h-screen w-full'>
		...
		<TripleColumnContainer>
			<section className='flex-1 basis-1/3'>
				<h2 className='font-bold text-4xl'>Discover</h2>
				<ul className='py-2'>
			...
			<section className='flex-1 basis-1/3'>
				<h2 className='font-bold text-4xl'>Design</h2>
				<ul className='py-2'>
					<li className='py-2'>Tools</li>
					<li className='py-2'>Active Recall</li>
					<li className='py-2'>Repetition</li>
				</ul>
			</section>
			<section className='flex-1 basis-1/3'>
				<h2 className='font-bold text-4xl'>Deploy</h2>
				<ul className='py-2'>
					<li className='py-2'>Test Results</li>
					<li className='py-2'>Performance Results</li>
				</ul>
			</section>
		</TripleColumnContainer>
	</SingleColumn>
